...
const Footer = () => {
    return (
        <footer className="mt-4 footer footer-center p-10 bg-neutral text-neutral-content">
            <div>
                ...
                <p className="font-bold">
                    <h2 className='text-xl'>BIMT<span>ian</span></h2> <br />A community with high expectation and high academic achievement
                </p>
                <p>Copyright &#169; {new Date().getFullYear()} - All right reserved</p>
            </div>
            <div>
                <div className="grid grid-flow-col gap-4">
                    <h2 className='text-l font-bold'>Meet with Developer:</h2>
                    <a href="https://facebook.com/kazi.mamun.716" target="_blank" rel="noreferrer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current text-blue-400"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
                </div>
            </div>
        </footer>
    );
